...
from .views import create_user,create_role,view_all_roles,view_all_users,user_login,view_profile,is_schedule_restricted,GetAllRolesView
...
urlpatterns = [
    ...
    path('role/',GetAllRolesView.as_view())
